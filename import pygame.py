...
def build_images():
    ...
    parts = ('head', 'body', 'tail', 'curve')
    head_img, body_img, tail_img, curve_img = [load(p) for p in parts]
    ...
    return {
        ...
        'BODY_NE': pygame.transform.rotate(curve_img, 180),
        'BODY_WS': pygame.transform.rotate(curve_img, 180),
        'BODY_WN': pygame.transform.rotate(curve_img, 90),
        'BODY_SE': pygame.transform.rotate(curve_img, 90),
        'BODY_ES': pygame.transform.rotate(curve_img, -90),
        'BODY_NW': pygame.transform.rotate(curve_img, -90),
        'BODY_EN': pygame.transform.rotate(curve_img, 0),
        'BODY_SW': pygame.transform.rotate(curve_img, 0),
        'TAIL_N': tail_img,
